...
- **CORS Dinámico (Reflection)**: Se cambió la estrategia a `origin: true` para reflejar dinámicamente el origen de la petición. Esto elimina errores por diferencias sutiles en strings o protocolos, garantizando que si el cliente tiene credenciales válidas, logre conectar. Se añadió logging de `Origin` para debug.
